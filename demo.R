...
output_allocation <- allocation(demand_raster = pop, sf_area = boundary, facilities=fountains, weights=NULL, objectiveminutes=15, objectiveshare=0.01, heur="max", dowscaling_model_type="lm", mode="walk", res_output=1000)
...
output_allocation_weighted <- allocation(demand_raster = pop, sf_area = boundary, facilities=fountains, weights=hotdays, objectiveminutes=15, objectiveshare=0.01, heur="max", dowscaling_model_type="lm", mode="walk", res_output=1000)
...
output_allocation_discrete <- allocation_discrete(demand_raster = pop, sf_area = boundary, facilities=fountains, candidate=candidates, max_fac = 10, weights=NULL, objectiveminutes=15, dowscaling_model_type="lm", mode="walk", res_output=1000, n_samples=100)
...
output_allocation_discrete_from_scratch <- allocation_discrete(demand_raster = pop, sf_area = boundary, facilities=NULL, candidate=candidates, max_fac = 10, weights=NULL, objectiveminutes=15, dowscaling_model_type="lm", mode="walk", res_output=1000, n_samples=100)
