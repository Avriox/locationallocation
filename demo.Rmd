...
output_allocation_discrete <- allocation_discrete(demand_raster = pop, sf_area = boundary, facilities=fountains, candidate=candidates, n_fac = 10, traveltime=out_tt, weights=NULL, objectiveminutes=15)
